...
I researched and wrote this blog while working at Immersive Labs and have reuploaded it here to my personal blog website. If you want to see the original publication, please visit the [Immersive Labs](https://www.immersivelabs.com/blog/havoc-c2-framework-a-defensive-operators-guide) website.
...
![Havoc use by quarter 2023](assets/images/blogs/Havoc-c2-defensive-ops/havoc-by-quarter.png)
...
![The range setup](assets/images/blogs/Havoc-c2-defensive-ops/the-range.png)
...
![Havoc-archetecture](assets/images/blogs/Havoc-c2-defensive-ops/havoc-arch.png)
...
![aes and iv](assets/images/blogs/Havoc-c2-defensive-ops/aes-and-iv.png)
...
![aes from sqlite server](assets/images/blogs/Havoc-c2-defensive-ops/aes-from-sqlite.png)
...
![deadbeef found in wireshark](assets/images/blogs/Havoc-c2-defensive-ops/deadbeef-in-wireshark.png)
...
![defines dot h](assets/images/blogs/Havoc-c2-defensive-ops/definesdoth.png)
...
![wirehsark polling requests](assets/images/blogs/Havoc-c2-defensive-ops/wireshark-polling.png)
...
![wirehsark sections](assets/images/blogs/Havoc-c2-defensive-ops/wireshark-sections.png)
...
![Copy value out](assets/images/blogs/Havoc-c2-defensive-ops/copy-value.png)
...
![Copy value out](assets/images/blogs/Havoc-c2-defensive-ops/aescryptdoth.png)
...
![Cyberchef output](assets/images/blogs/Havoc-c2-defensive-ops/cyberchef-command-output.png)

The image below shows the rough location where the beginning of the output is located, based on the CyberChef output.

![Beginning of output](assets/images/blogs/Havoc-c2-defensive-ops/beginning-output.png)
...
![Process-id](assets/images/blogs/Havoc-c2-defensive-ops/process-id-5544.png)
...
![Process-id](assets/images/blogs/Havoc-c2-defensive-ops/keys-in-memory.png)
